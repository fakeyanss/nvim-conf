...
local basic_map = {
    ...
    ["n|<S-h>"] = map_cmd("<ESC>^i"):with_noremap():with_desc("editn: Move cursor to line start"),
    ["n|<S-l>"] = map_cmd("<ESC>$a"):with_noremap():with_desc("editn: Move cursor to line end"),
...
plugin_key_mapping["markdown-preview"] = function()
    bind.nvim_load_mapping({
        ["n|<F12>"] = map_cr("MarkdownPreview"):with_noremap():with_silent():with_desc("tool: Preview markdown"),
    })
end
